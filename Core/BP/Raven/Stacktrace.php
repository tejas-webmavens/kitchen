 ...
 * @package raven
 */
class Core_BP_Raven_Stacktrace
{
    ...
    public static function get_stack_info($frames,
                                          $trace = false,
                                          $errcontext = null,
                                          $frame_var_limit = Core_BP_Raven_Client::MESSAGE_LIMIT,
                                          $strip_prefixes = null,
                                          $app_path = null,
                                          $excluded_app_paths = null,
                                          Core_BP_Raven_Serializer $serializer = null,
                                          Core_BP_Raven_ReprSerializer $reprSerializer = null)
    {
        $serializer = $serializer ?: new Core_BP_Raven_Serializer();
        $reprSerializer = $reprSerializer ?: new Core_BP_Raven_ReprSerializer();
    ...
    public static function get_default_context($frame, $frame_arg_limit = Core_BP_Raven_Client::MESSAGE_LIMIT)
    {
        if (!isset($frame['args'])) {
            return array();
        }
    ...
    public static function get_frame_context($frame, $frame_arg_limit = Core_BP_Raven_Client::MESSAGE_LIMIT)
    {
        if (!isset($frame['args'])) {
            return array();
        }
