...
class Core_BP_Raven_Breadcrumbs_MonologHandler extends AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct(Core_BP_Raven_Client $ravenClient, $level = Logger::DEBUG, $bubble = true)
    {
