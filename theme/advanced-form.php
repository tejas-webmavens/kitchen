...
<head>
    ...
    <link href="required/custom-select/custom-select.css" rel="stylesheet" type="text/css" />
    <link href="required/switchery/dist/switchery.min.css" rel="stylesheet" />
    <link href="required/bootstrap-select/bootstrap-select.min.css" rel="stylesheet" />
    <link href="required/bootstrap-tagsinput/dist/bootstrap-tagsinput.css" rel="stylesheet" />
    <link href="required/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css" rel="stylesheet" />
    <link href="required/multiselect/css/multi-select.css" rel="stylesheet" type="text/css" />
...
<body>
                        ...
                        <div class="white-box">
                            <form method="post">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label">SWITCHERIES</label>
                                            <div>
                                                <input type="checkbox" checked class="js-switch" data-color="#3d3b3b" />
                                                ...
                                                <input type="checkbox" checked class="js-switch" data-color="#ffca4a" data-size="large" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input class="vertical-spin" type="text" data-bts-button-down-class="btn btn-default btn-outline" data-bts-button-up-class="btn btn-default btn-outline" value="" name="vertical-spin">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Postfix</label>
                                    <input id="tch1" type="text" value="55" name="tch1" data-bts-button-down-class="btn btn-default btn-outline" data-bts-button-up-class="btn btn-default btn-outline">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Prefix</label>
                                    <input id="tch2" type="text" value="0" name="tch2" class=" form-control" data-bts-button-down-class="btn btn-default btn-outline" data-bts-button-up-class="btn btn-default btn-outline">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label">Single select2</label>
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="control-label">Multiple select boxes</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 form-group">
                                        <label class="control-label">Pre-selected options</label>
                                    ...
                                    <div class="col-lg-4 col-sm-6 form-group">
                                        <label class="control-label">Optgroup</label>
                                    ...
                                    <div class="col-lg-4 col-sm-6 form-group">
                                        <label class="control-label">Public methods</label>
    ...
    <script src="required/switchery/dist/switchery.min.js"></script>
    <script src="required/custom-select/custom-select.min.js" type="text/javascript"></script>
    <script src="required/bootstrap-select/bootstrap-select.min.js" type="text/javascript"></script>
    <script src="required/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js"></script>
    <script src="required/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="required/multiselect/js/jquery.multi-select.js"></script>
    <script>
