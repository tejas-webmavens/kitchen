...
<body>
                ...
                <div class="row">
                    <div class="col-xs-12">
	                    <div class="white-box">
	                    	<div class="row">
	                    		<div class="col-xs-12">
	                    			<h3 class="box-title table-search-input-title">Converstion report</h3>
	                    			...
	                    			<ul class="list-inline reports-filters">
	                    				<li>
	                    					<select class="form-control">
	                    						<option value="" selected>UTM Channel</option>
	                    					</select>
	                    				</li>
	                    				<li>
	                    					<select class="form-control">
	                    						<option value="" selected>UTM Source</option>
	                    					</select>
	                    				</li>
	                    				<li>
	                    					<select class="form-control">
	                    				...
	                    				<li class="bt-switch">
				                            <label for="checkbox-signup">Lead Generated &nbsp; </label>
	                    					<input type="checkbox" checked data-size="small" data-on-color="success" />
	                    				</li>
	                    			</ul>
	                    			<div class="m-b-40"></div>
                ...
                <div class="row">
                    <div class="col-xs-12">
	                    <div class="white-box">
	                    	<div class="row">
	                    		<div class="col-xs-12">
	                    			<h3 class="box-title table-search-input-title">Revisit report</h3>
	                    			<div class="m-b-40"></div>
	                    		</div>
	                    	</div>
	                    	<div class="row">
                ...
                <div class="row">
                    <div class="col-xs-12">
	                    <div class="white-box">
	                    	<div class="row">
	                    		<div class="col-xs-12">
	                    			<h3 class="box-title table-search-input-title">UTM bifurcation report</h3>
	                    		</div>
	                    	</div>
	                    	<div class="row">
	                    		<div class="col-xs-12">
	                    			<ul class="list-inline reports-filters">
	                    				<li>
	                    					<select class="form-control">
	                    						<option value="" selected>UTM Campaign Source</option>
	                    					</select>
	                    				</li>
	                    				<li>
	                    					<select class="form-control">
	                    						<option value="" selected>UTM Campaign Medium</option>
	                    					</select>
	                    				</li>
	                    				<li>
	                    					<select class="form-control">
	                    						<option value="" selected>UTM Campaign Name</option>
	                    					</select>
	                    				</li>
	                    				<li>
	                    					<select class="form-control">
	                    						<option value="" selected>UTM Campaign Term</option>
	                    					</select>
	                    				</li>
	                    				<li>
					                        <div class="date-range-side pull-right">
	                    			...
	                    			<div class="table-responsive">
		                                <table class="table">
		                                    <thead>
		                                        <tr>
		                                            <th>Visitor Id</th>
		                                            <th>UTM Campaign Source</th>
		                                            <th>UTM Campaign Medium</th>
		                                            <th>UTM Campaign Name</th>
		                                            <th>UTM Campaign Term</th>
		                                            <th>Acquisition Date</th>
		                                            <th>Date Last Seen</th>
		                                            <th>Lead Generate</th>
		                                        </tr>
    ...
    <script src="required/bootstrap-switch/bootstrap-switch.min.js"></script><script type="text/javascript">
