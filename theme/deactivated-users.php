            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h4 class="page-title">Deactivated Users <span class="label label-warning">160</span></h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    	...
                                    	<tr data-url="">
                                    		...
                                    		<td>
                                    			<div class="action-wrapp">
	                                    			...
	                                    			<a href="#" class="btn btn-primary btn-icon" title="Activate" data-toggle="tooltip"><i class="icon-user"></i></a>
                                    			</div>
                                    		</td>
                                    	</tr>
                                    </tbody>
