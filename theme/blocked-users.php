            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h4 class="page-title">Blocked Users <span class="label label-warning">160</span></h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                        	<h3 class="box-title table-search-input-title">Blocked Users list comes here</h3>
                                    	...
                                    	<tr data-url="">
                                    		...
                                    		<td>
                                    			<div class="action-wrapp">
	                                    			...
	                                    			<a href="#" class="btn btn-danger btn-icon" title="Remove" data-toggle="tooltip"><i class="ti-trash"></i></a>
	                                    			<a href="#" class="btn btn-primary btn-icon" title="Enable" data-toggle="tooltip"><i class="ti-check"></i></a>
	                                    			<a href="#" class="btn btn-warning btn-icon" title="Deactivate" data-toggle="tooltip"><i class="icon-user-unfollow"></i></a>
                                    			</div>
                                    		</td>
                                    	</tr>
                                    </tbody>
