            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h4 class="page-title">Active Users <span class="label label-warning">160</span></h4>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                        	<h3 class="box-title table-search-input-title">Active Users list comes here</h3>
                                    	...
                                    	<tr data-url="">
                                    		...
                                    		<td>
                                    			<div class="action-wrapp">
	                                    			<a href="user-detail.php" class="btn btn-success btn-icon" title="View" data-toggle="tooltip"><i class="icon-action-redo"></i></a>
	                                    			<a href="edit-user.php" class="btn btn-warning btn-icon" title="Edit" data-toggle="tooltip"><i class="icon-ban"></i></a>
	                                    			<a href="#" class="btn btn-primary btn-icon" title="Deactivate" data-toggle="tooltip"><i class="icon-user-unfollow"></i></a>
                                    			</div>
                                    		</td>
                                    	</tr>
                                    </tbody>
